...
//            System.out.println(Arrays.toString(test));
    ...
    private static String pickFile() {
    	...
    	return inputsFolder.getAbsolutePath() + "\\" + choice; // Return path to selected file.
    }
    ...
    public static void main(String[] args) {
        ...
        if (argsLength > 0) { // Check for command line args.
        ...
        } else { // Ask user for database and number of suggestions using GUI:
			filename = pickFile();	
